...
const BASE: Passo[] = [
  ...
  { toque: 4, dia: 13, canal: "ligacao", titulo: "Ligação: retomar o gancho dos e-mails e buscar uma agenda" },
  { toque: 5, dia: 16, canal: "email", chave: "frio_5" },
  { toque: 6, dia: 20, canal: "whatsapp", titulo: "WhatsApp: mensagem breve, mudando de canal depois dos e-mails" },
  { toque: 7, dia: 25, canal: "ligacao", titulo: "Ligação: pergunta objetiva e pedido de agenda" },
  { toque: 8, dia: 35, canal: "email", chave: "frio_8" },
  { toque: 9, dia: 40, canal: "ligacao", titulo: "Ligação: terceira tentativa de contato direto" },
  { toque: 10, dia: 45, canal: "email", chave: "frio_10" },
  { toque: 11, dia: 50, canal: "whatsapp", titulo: "WhatsApp: oferecer uma novidade concreta" },
